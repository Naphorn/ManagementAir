...
<body id="body_background">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" id="navbar_fix_background">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                <li class="nav-item">
                    <a class="nav-link" href="level1"><font color="blue">Level 1</font></a>
                </li>
                <li class="nav-item">
    ...
    <img src="https://github.com/Naphorn/ManagementAir/blob/master/resources/views/images/level1-1.png?raw=true" class="rounded mx-auto d-block">
